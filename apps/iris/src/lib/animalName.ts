import animals from '../../../iris-files/src/utils/data/animals.json' with { type: 'json' };
import adjectives from '../../../iris-files/src/utils/data/adjectives.json' with { type: 'json' };

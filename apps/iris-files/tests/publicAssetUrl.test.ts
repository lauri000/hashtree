...
import { resolveWorkerPublicAssetUrl } from '../src/lib/publicAssetUrl';
...
describe('resolveWorkerPublicAssetUrl', () => {
  ...
  it('preserves fully qualified base urls', () => {
    expect(
      resolveWorkerPublicAssetUrl('https://cdn.example.com/app/', 'secp256k1.wasm', {
        importMetaUrl: 'https://example.com/assets/worker-abc123.js',
        origin: 'https://example.com',
      }),
    ).toBe('https://cdn.example.com/app/secp256k1.wasm');
  });
});

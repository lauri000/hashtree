...
const directoryLookupCache = createAsyncLookupCache<
  Awaited<ReturnType<HashTree['listDirectory']>> | null
>(DIRECTORY_CACHE_SIZE);
const resolvedEntryLookupCache = createAsyncLookupCache<ResolvedRootEntry | null>(

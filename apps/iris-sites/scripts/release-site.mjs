...
export const releaseProfile = {
  ...
  testCommands: [
    ['pnpm', 'exec', 'vitest', 'run', 'tests/siteConfig.test.ts', 'tests/siteHost.test.ts', 'tests/runtimeUi.test.ts', 'tests/launchInput.test.ts', 'tests/bootShellMarkup.test.ts', 'tests/portableBuildConfig.test.ts', 'tests/releaseSite.test.ts'],
